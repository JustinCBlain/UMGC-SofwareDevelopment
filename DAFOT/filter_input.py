...
"""
print(filter_input("Enter anything at all"))
print(filter_input("Pick a number between 3 and 7.", [3, 7], int))
print(filter_input("What's your fav fruit?", ['apple', 'orange', 'bananaNAH']))
"""